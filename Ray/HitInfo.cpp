...
HitInfo::HitInfo(const float& t1, const float& t2, const Ray& ray, const Vector3& origin, std::shared_ptr<Material> material, short id)
...
short HitInfo::getId() const
{
    return this->id;
}

void HitInfo::setT1(float t1)
{
    this->t1 = t1;
}
